        ...
        <div class="col-10" id="dash_title">
          ...
          <div id="dash_Box">
            ...
            while ($row = mysqli_fetch_array($result)) { 
              ...
              echo "<td style='text-align:center; padding-top: 1vh; padding-bottom:1vh'>" . $row['Priority'] . "</td>";
              echo "<td style='text-align:center; padding-top: 1vh; padding-bottom:1vh'>" . $row['ID'] . "</td>";
              echo "<td style='text-align:center; padding-top: 1vh; padding-bottom:1vh'>" . $row['poster'] . "</td>";
              echo "<td style='text-align:center; padding-top: 1vh; padding-bottom:1vh'>" . $row['Title'] . "</td>";
              echo "<td style='padding-left:1.5vw; padding-top: 1vh; padding-bottom:1vh; max-width:40vw;  overflow-wrap: break-word;'>" . $row['issue_desc'] . "</td>";
              echo "<td style='padding-top: 1vh; padding-bottom:1vh; margin-right:4vw;max-width:0.5vw;'><button class='btn btn-dark' style='width:2vw; margin-left:7vw;'><i class='fa-solid fa-circle-check'></i></button><button type='submit' class='btn btn-dark' style='margin-left:0.5vw;' type='submit' name='Delete' value=".$row['ID']."><i class='fa-solid fa-trash'></i></button>" . "</td>";
